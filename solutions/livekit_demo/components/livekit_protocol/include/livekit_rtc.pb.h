...
#define LIVEKIT_PB_TRACK_PUBLISHED_RESPONSE_INIT_DEFAULT {{{NULL}, NULL}, false, LIVEKIT_PB_TRACK_INFO_INIT_DEFAULT}
...
#define LIVEKIT_PB_TRACK_PUBLISHED_RESPONSE_INIT_ZERO {{{NULL}, NULL}, false, LIVEKIT_PB_TRACK_INFO_INIT_ZERO}
...
#define LIVEKIT_PB_TRACK_PUBLISHED_RESPONSE_CALLBACK pb_default_field_callback
...
#define LIVEKIT_PB_PARTICIPANT_UPDATE_CALLBACK pb_default_field_callback

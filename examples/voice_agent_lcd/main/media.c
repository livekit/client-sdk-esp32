...
static int build_capturer_system(void) {
  ...
  esp_capture_audio_aec_src_cfg_t codec_cfg = {
      .record_handle = record_handle, .channel = 4, .channel_mask = 1 | 2};
...
static int build_renderer_system(void) {
  ...
  NULL_CHECK(renderer_system.av_renderer_handle,
             "Failed to create AV renderer");
